...
if TYPE_CHECKING:
    from guidogerb.modules.agents import Agent, BaseAgent
    from guidogerb.config import Config

from guidogerb.modules.json_utils.utilities import extract_dict_from_response
from guidogerb.modules.llm.base import ChatSequence, Message
from guidogerb.modules.llm.providers.openai import OPEN_AI_CHAT_MODELS
from guidogerb.modules.llm.utils import (
    count_message_tokens,
    count_string_tokens,
    create_chat_completion,
)
from guidogerb.modules.logs import (
