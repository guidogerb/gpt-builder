"""Logging module for GuidoGerb-GPT."""
...
if TYPE_CHECKING:
    from guidogerb.config import Config

from guidogerb.singleton import Singleton

from .formatters import GuidoGerbGptFormatter, JsonFormatter
...
class Logger(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        console_formatter = GuidoGerbGptFormatter("%(title_color)s %(message)s")
        ...
        info_formatter = GuidoGerbGptFormatter(
        ...
        error_formatter = GuidoGerbGptFormatter(
    ...
    def typewriter_log(
        ...
        from guidogerb.modules.speech import say_text
    ...
    def double_check(self, additionalText: Optional[str] = None) -> None:
        if not additionalText:
            additionalText = (
                ...
                " correctly. Read https://github.com/Torantulino/GuidoGerb-GPT#readme to "
