...
if TYPE_CHECKING:
    from guidogerb.config import AIConfig, Config
    from guidogerb.modules.llm.base import ChatModelResponse, ChatSequence
    from guidogerb.modules.memory.vector import VectorMemory
    from guidogerb.modules.models.command_registry import CommandRegistry

from guidogerb.modules.json_utils.utilities import extract_dict_from_response, validate_dict
from guidogerb.modules.llm.api_manager import ApiManager
from guidogerb.modules.llm.base import Message
from guidogerb.modules.llm.utils import count_string_tokens
from guidogerb.modules.logs import logger
from guidogerb.modules.logs.log_cycle import (
...
from guidogerb.workspace import Workspace
