...
from guidogerb.modules.utils import utils
from guidogerb.config.app_config import Config
from guidogerb.config.app_config import GPT_3_MODEL, GPT_4_MODEL
from guidogerb.modules.llm.api_manager import ApiManager
from guidogerb.modules.logs import logger
...
def create_config(
    ...
    Args:
        ...
        allow_downloads (bool): Whether to allow GuidoGerb-GPT to download files natively
    ...
    if memory_type:
        logger.typewriter_log("Memory Type not supported: ", Fore.GREEN, "DISABLED")
    ...
    if allow_downloads:
        ...
        logger.typewriter_log(
            "WARNING: ",
            Fore.YELLOW,
            f"{Back.LIGHTYELLOW_EX}GuidoGerb-GPT will now be able to download and save files to your machine.{Back.RESET} "
