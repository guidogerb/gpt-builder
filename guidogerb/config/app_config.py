...
from guidogerb.config.schema import Configurable, SystemSettings
from guidogerb.modules.llm.providers.openai import OPEN_AI_CHAT_MODELS

LOG_DIR="guidogerb/modules/logs/log"
...
def check_openai_api_key(config: Config) -> None:
    """Check if the OpenAI API key is set in app_config.py or as an environment variable."""
