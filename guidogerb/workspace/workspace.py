...
The workspace is a directory containing configuration and working files for an GuidoGerbGPT
agent.
...
class Workspace:
    """A class that represents a workspace for an GuidoGerbGPT agent."""
